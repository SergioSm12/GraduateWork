...
export const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`xl:h-[100vh] overflow-y-scroll fixed xl:static  w-[80%] md:w-[40%] lg:w-[30%] xl:w-auto h-full 
     top-0 bg-secondary-100 p-4 flex flex-col justify-between z-50 ${
          ...
          <ul>
            ...
            <li>
              <Link
                ...
                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-secondary-900 transition-colors"
              >
                <RiParkingBoxLine className="text-primary" />
                Administrar aforo.
              </Link>
            </li>
          </ul>
